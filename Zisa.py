...
os.system('espeak -a 300 " Welcome.   to.  Tutul. baba."')
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mChecking Update...? ')
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY SCRIPT GIFT GROUP")
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/763244377369337/')
#------------------[ Tutul-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def menu():
    ...
    print('\033[0;97m===============================================')
    print(f"""\033[97;1m[\033[92;1m1\033[97;1m] \033[0;92mTutul ER MA+BOW ER VODA        """)
    print("""\033[97;1m[\033[92;1m2\033[97;1m] \033[0;93mCONTACT WITH Tutul ER REAL BAP""")
    print("""\033[97;1m[\033[92;1m0\033[97;1m] \033[0;91mEXIT""")
    print('\033[0;97m=================')
    Tutul = input('\x1b[1;92m[+] GUTA DITE 1 CHAPO: ')
    if Tutul in ['111']:
        login()
        dump_massal()
    elif Tutul in ['1']:
        ...
        os.system('xdg-open https://wa.me/+8801888752730')
        os.system("python nono.py")
    elif Tutul in ['3','03']:
        result()
    elif Tutul in ['0']:
